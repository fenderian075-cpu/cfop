...
const EN={
  ...
  '目次':'Contents',
  '作り方':'Setup','長押しで作り方を表示':'Long-press to show setup moves','⤒ ページ先頭':'⤒ Top of page','ページ切替。左右スワイプで前後ページ':'Page navigation. Swipe horizontally for previous or next',
  ...
  '右手・手首':'Right hand/wrist','左手・手首':'Left hand/wrist',
  'ホームグリップから手首の返しで回す。持ち替えないと直後のR\'につなげやすい':"Turn with a wrist flick from home grip. Skipping the regrip flows into the next R'",
  'Rの鏡映。親指を添えて挟む持ち方が使えるのは主にL・R':'Mirror of R. The thumb-assisted pinch grip mainly applies to L and R',
  ...
  '練習':'Practice','クイズ':'Quiz','ケースを見て手順を即答':'See the case and recall the algorithm','ケースを見て手順を即答する。判定は自分の手で。':'See the case and recall the algorithm instantly. Judge the result yourself.','手順を表示':'Show Algorithm','次のケース':'Next Case','この手順は?':'Which algorithm?','出題範囲を選択':'Select quiz categories',
