...
const EN={
  ...
  '指使いの基本':'Finger tricks','回すのは手首ではなく指':'Turn with fingers, not wrists',
  '回転':'Move','指':'Finger','コツ':'Tip',
  '右人差し指':'Right index','左人差し指':'Left index','右人差し指→中指':'Right index → middle','右手首':'Right wrist','左手首':'Left wrist','右親指':'Right thumb','薬指':'Ring finger',
  '引き金を引くように手前へ弾く(トリガー)。他の指はU面に触れない':'Flick toward you like pulling a trigger. Keep other fingers off the U face',
  'Uの鏡映。親指プッシュで代用する癖はNG':"Mirror of U. Don't substitute a thumb push",
  ...
  'やってはいけない回し方: ':"What not to do: ",
  'U系を親指で挟んで回す':'thumb-pinching U turns','回す際に手がキューブから離れる':'letting the hand leave the cube','親指プッシュのU\'多用':"overusing thumb-push U'",
  '。共通する問題は「手の動きが大きい/ホールドが浮く」ことで、30秒を切るあたりから確実に壁になる。正しい指使いのコツは、何もない所で指を自然に曲げる動き——その動きだけで回すこと。指に変な力がかかる回し方は基本的に間違い。':". The common problem is large hand motion and a floating hold — it becomes a hard wall around sub-30s. The right feel: curl your finger naturally in the air, and turn with exactly that motion. If a turn strains the finger, it's the wrong turn.",
  ...
  'どの白エッジも理論上2手あれば定位置に運べる。3手以上かかる動かし方をしていたら、より短い経路を探す癖をつける':'Any white edge can theoretically reach home in 2 moves. If you take 3+, train yourself to look for a shorter path',
  '④ インスペクションで完成形まで読む':'4. Plan the full cross in inspection',
  '実際に回す前に頭の中でキューブを回してクロス完成まで手順を決める。15秒に収まらなくても、練習では時間無制限でじっくり考えてよい——脳内で回す負荷こそが練習':"Decide the whole cross mentally before turning. In practice, take unlimited time — the mental load of turning the cube in your head IS the training",
